...
const SelectorEstudiantes = ({ onSeleccionEstudiante, usuarioActual, actualizacionNotas }) => {
  ...
  useEffect(() => {
    const obtenerEstudiantes = async () => {
      try {
        ...
        // Si el backend devuelve un array de objetos con usuario anidado, mapearlo
        const estudiantes = Array.isArray(data)
          ? data.map(e => ({
              id: e.id,
              nombre: e.usuario?.nombre || e.nombre || '',
              username: e.usuario?.username || e.username || '',
              grupo: e.grupo || '',
          ...
          <div className="lista-estudiantes">
            {estudiantesFiltrados.map((estudiante) => (
              <div
                ...
                onClick={() => {
                  onSeleccionEstudiante(estudiante);
                }}
              >
                ...
                <div className="info-estudiante">
                  ...
                  <div className="info-secundaria">
                    ...
                    <span className="promedio-estudiante" style={{color:"#000000"}}>Promedio: {estudiante.promedio}</span>
